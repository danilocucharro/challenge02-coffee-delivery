...
export function Banner() {
  return(
    <div className="flex mt-36 max-mobile:mt-24 px-40 items-center justify-between max-w-[1440px] h-[544px] desktop:bg-banner max-mobile:bg-background max-mobile:px-5 max-mobile:flex-col max-mobile:h-auto">
